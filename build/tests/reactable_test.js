(function (global, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        factory(mod.exports);
        global.reactable_test = mod.exports;
    }
    ...
    var ReactableTestUtils = {
        ...
        expectRowClass: function expectRowClass(rowIndex, className) {
        ...
        expectRowText: function expectRowText(rowIndex, textArray) {
        ...
        describe('Adding a <Tfoot>', function () {
            before(function () {
                React.render(React.createElement(
                    ...
                    React.createElement(Reactable.Tr, { className: 'rowClass2', data: { Age: '23', Name: 'Lee Salminen' } }),
                    React.createElement(Reactable.Tr, { className: 'rowClass3', data: { Age: '28', Position: 'Developer' } }),
                    React.createElement(
                        Reactable.Tfoot,
                        { id: 'tfoot' },
                        React.createElement(
                ...
                before(function () {
                    React.render(React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                Reactable.Td,
                                { column: 'Position', className: 'position' },
                                'Developer'
                            ),
                            React.createElement(
                                Reactable.Td,
        ...
        describe('unsafe() strings', function () {
            ...
            context('in column labels', function () {
                ...
                it('renders the HTML in the column headers', function () {
                    ...
                    expect(headers).to.eql(['<strong>Name</strong>', '<em>Age</em>', '<small>Position</small>']);
                });
            });
            ...
            context('in the <Tr>s', function () {
                before(function () {
                    React.render(React.createElement(
                        ...
                        React.createElement(Reactable.Tr, { data: { Age: '23', Name: Reactable.unsafe('<span id="lees-name">Lee Salminen</span>') } }),
                        React.createElement(Reactable.Tr, { data: { Age: '28', Position: Reactable.unsafe('<span id="who-knows-job">Developer</span>') } })
                    ), ReactableTestUtils.testNode());
                });
                    ...
                    React.render(React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                Reactable.Td,
                                { column: 'Name' },
                                Reactable.unsafe('<span id="griffins-name">Griffin Smith</span>')
                            ),
                            React.createElement(
                                Reactable.Td,
                                { column: 'Age' },
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                Reactable.Td,
                                { column: 'Name' },
                                Reactable.unsafe('<span id="lees-name">Lee Salminen</span>')
                            ),
                            React.createElement(
                                Reactable.Td,
                                { column: 'Age' },
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                Reactable.Td,
                                { column: 'Position' },
                                Reactable.unsafe('<span id="who-knows-job">Developer</span>')
                            ),
                            React.createElement(
                                Reactable.Td,
                                { column: 'Age' },
            ...
            describe('no default sort', function () {
                before(function () {
                    React.render(React.createElement(Reactable.Table, { className: 'table', id: 'table', data: [{ Name: 'Lee Salminen', Age: '23', Position: 'Programmer' }, { Name: 'Griffin Smith', Age: '18', Position: 'Engineer' }, { Name: 'Ian Zhang', Age: '28', Position: 'Developer' }],
                        ...
                        }, 'Age', 'Position'] }), ReactableTestUtils.testNode());
                });
            ...
            describe('default sort', function () {
                before(function () {
                    React.render(React.createElement(Reactable.Table, { className: 'table', id: 'table', data: [{ Name: 'Lee Salminen', Age: '23', Position: 'Programmer' }, { Name: 'Griffin Smith', Age: '18', Position: 'Engineer' }, { Name: 'Ian Zhang', Age: '28', Position: 'Developer' }],
                        ...
                        defaultSort: { column: 'Age', direction: 'desc' } }), ReactableTestUtils.testNode());
                });
            ...
            describe('default sort no direction specified', function () {
                before(function () {
                    React.render(React.createElement(Reactable.Table, { className: 'table', id: 'table', data: [{ Name: 'Lee Salminen', Age: '23', Position: 'Programmer' }, { Name: 'Griffin Smith', Age: '18', Position: 'Engineer' }, { Name: 'Ian Zhang', Age: '28', Position: 'Developer' }],
                        ...
                        defaultSort: 'Age' }), ReactableTestUtils.testNode());
                });
            ...
            context('filtering and pagination together', function () {
                before(function () {
                    React.render(React.createElement(Reactable.Table, { className: 'table', id: 'table', data: [{ 'State': 'New York', 'Description': 'this is some text', 'Tag': 'new' }, { 'State': 'New Mexico', 'Description': 'lorem ipsum', 'Tag': 'old' }, { 'State': 'Colorado', 'Description': 'new description that shouldn\'t match filter',
                        ...
                        filterable: ['State', 'Tag'],
                        columns: ['State', 'Description', 'Tag'],
                        itemsPerPage: 2 }), ReactableTestUtils.testNode());
                });
